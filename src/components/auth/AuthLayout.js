  ...
  render () {
    return (
      <div style={{paddingTop: 100, textAlign: 'center'}}>
        ...
        <div style={{background: '#222', backgroundSize: 'cover', backgroundImage: 'url(https://assets.daheimapp.de/media/daheim_hero.jpg),url(https://assets.daheimapp.de/media/daheim_hero@tiny.jpg)', position: 'fixed', top: 0, right: 0, bottom: 0, left: 0}}></div>
